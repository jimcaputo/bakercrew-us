...
def fetch():
    ...
    for row in rows[3:27]:
        ...
        if len(cols[1].string) == 1:
            nwac_time += '00:00:00'
            nwac_time_display = cols[0].string + ' ' + '00:00'
        elif len(cols[1].string) == 3:
            nwac_time += '0' + cols[1].string[0] + ':00:00'
            nwac_time_display = cols[0].string + ' ' + cols[1].string[0] + ':00'
        elif len(cols[1].string) == 4:
            nwac_time += cols[1].string[0:2] + ':00:00'
            nwac_time_display = cols[0].string + ' ' + cols[1].string[0:2] + ':00'
        ...
        results.append({
            'nwac_time': nwac_time,
            'nwac_time_display': nwac_time_display,
